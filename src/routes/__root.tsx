  ...
  head: () => ({
    meta: [
      ...
      { title: "test" },
      {
        name: "description",
        content:
          "Handcrafted fresh tea, boba and collagen drinks — Melbourne born, Taiwan grown, now in Jeddah.",
      },
      { name: "author", content: "Gotcha Fresh Tea" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300;9..144,500;9..144,600;9..144,700&family=Poppins:wght@300;400;500;600;700&family=El+Messiri:wght@500;600;700&family=Tajawal:wght@300;400;500;700&display=swap",
      },
